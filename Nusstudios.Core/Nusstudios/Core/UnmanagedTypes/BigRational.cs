...
namespace Nusstudios.Core.UnmanagedTypes
{
    public struct BigRational : IComparable, IComparable<BigRational>, IDeserializationCallback, IEquatable<BigRational>, ISerializable
    {
        ...
        public string ToDecimalString(int accuracy)
        {
            List<string> lst = new List<string>();
            lst.Add(m_numerator.ToString());
            lst.Add(Denominator.ToString());
            return StringMath.divide(lst, accuracy);
        }
        ...
        public override bool Equals(Object obj)
        {
            ...
            if (obj is BigRational br) return this.Equals(br);
            else return false;
        ...
        int IComparable.CompareTo(Object obj)
        {
            ...
            if (obj is BigRational br) return Compare(this, br);
            else throw new ArgumentException("Argument must be of type BigRational", "obj");
        }
        ...
        public BigRational(BigRational rational)
        {
            this = rational;
        }
